    ...
    return (
        <div className="page-wrapper" style={{ justifyContent: 'center' }}>
            <div className="card" style={{
                ...
                {error   && <p style={{ margin: 0, fontSize: '12px', color: 'var(--danger)' }}>{error}</p>}
                {success && <p style={{ margin: 0, fontSize: '12px', color: 'var(--success)' }}>{success}</p>}
                ...
                {form.confirm && (
                    <p style={{ fontSize: '11px', margin: 0, color: form.password === form.confirm ? 'var(--success)' : 'var(--danger)' }}>
