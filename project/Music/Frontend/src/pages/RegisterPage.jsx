    ...
    return (
        <div className="page-wrapper" style={{ justifyContent: 'center' }}>
            <div className="card" style={{
                ...
                {error   && <p style={{ margin: 0, fontSize: '12px', color: '#c0392b' }}>{error}</p>}
                {success && <p style={{ margin: 0, fontSize: '12px', color: '#27ae60' }}>{success}</p>}
                ...
                {form.confirm && (
                    <p style={{ fontSize: '11px', margin: 0, color: form.password === form.confirm ? '#27ae60' : '#c0392b' }}>
