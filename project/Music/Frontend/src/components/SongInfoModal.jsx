                ...
                <div className="info-image-section">
                    <div
                        style={{
                            ...
                            background: 'var(--action-bg)', border: '2px solid var(--muted-strong)',
                    ...
                    >
                        {imagePreview ? (
                            ...
                            <div style={{ width: '24px', height: '24px', borderRadius: '50%', background: 'var(--action-text)' }} />
                        )}
                    </div>
                    ...
                    <div className="info-image-right">
                        ...
                        {imageFile && (
                            <button className="info-image-btn" style={{ color: 'var(--danger)' }}
