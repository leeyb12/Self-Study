                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flex: 1 }}>
                            ...
                            <div
                                style={{
                                    ...
                                    background: 'var(--action-bg)', display: 'flex',
                            ...
                            >
                                {song.imageUrl ? (
                                    ...
                                    <div style={{ width: '16px', height: '16px', borderRadius: '50%', background: 'var(--action-text)' }} />
                                )}
                                {isLoggedIn && (
                                    <div style={{
                                    ...
                                    >
                                        <span style={{ fontSize: '18px', color: 'var(--action-text)', lineHeight: 1 }}>+</span>
                                    </div>
                                )}
                            </div>
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                                ...
                                {!song.imageUrl && isLoggedIn && (
                                    <p style={{ fontSize: '10px', color: 'var(--muted)', margin: '2px 0 0', letterSpacing: '0.04em' }}>
                                        CD 클릭으로 이미지 추가
                                    </p>
                                )}
                            </div>
