...
| `003/` | Java 실습 프로젝트 | `혼자공부하는자바` Eclipse 프로젝트와 Java 모듈 기본 구조 |
...
| `013/` | Java 개념 노트 | 변수, 변수 범위, 기본 타입과 정수 타입 Markdown 노트 |
...
| `003/README.md` | `혼자공부하는자바` Eclipse 프로젝트 구조와 현재 상태 |
...
`혼자공부하는자바` Eclipse Java 프로젝트를 관리합니다. 현재 `src/`에는 `module-info.java`만 있으며, 프로젝트와 모듈 이름은 모두 `혼자공부하는자바`입니다. 자세한 현재 상태는 [003 README](003/README.md)를 참고합니다.
...
`혼자공부하는자바 정리`에 2장 변수 관련 개념을 Markdown으로 정리합니다. `02-1`은 변수 선언, 초기화, 이름 규칙과 범위를 다루고, `02-2`는 Java 기본 타입과 정수 타입별 메모리 크기 및 허용 범위를 다룹니다. 노트 목록은 [013 README](013/README.md)를 참고합니다.
