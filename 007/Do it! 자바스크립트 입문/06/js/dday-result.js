...
document.querySelector('#accent').innerText = passedDay + "일";  // #access 영역에 표시합니다.

calcDate(100);  // 100일 기념일을 계산해서 표시합니다.
calcDate(200);  // 100일 기념일을 계산해서 표시합니다.
calcDate(365);  // 100일 기념일을 계산해서 표시합니다.
calcDate(500);  // 100일 기념일을 계산해서 표시합니다.
